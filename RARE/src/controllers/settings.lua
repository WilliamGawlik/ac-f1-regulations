...
function settings:load()
	...
	RARE_CONFIG = MappedConfig(settingsFile, {
		RULES = {
			...
			LIMIT_TYRE_COMPOUNDS = (ac.INIConfig.OptionalNumber == nil) and ac.INIConfig.OptionalNumber or 1,
			LIMIT_TYRE_START_PRESSURE = (ac.INIConfig.OptionalNumber == nil) and ac.INIConfig.OptionalNumber or 1,
			LIMIT_EOS_CAMBER = (ac.INIConfig.OptionalNumber == nil) and ac.INIConfig.OptionalNumber or 1,
			LIMIT_STATIC_CAMBER = (ac.INIConfig.OptionalNumber == nil) and ac.INIConfig.OptionalNumber or 0,
